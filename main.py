...
if __name__ == "__main__":
    ...
    text_input_dir = 'file:///home/user/learning/AWS_Spark_Unstructured/input/input_text'
    json_input_dir = 'file:///home/user/learning/AWS_Spark_Unstructured/input/input_json'
    csv_input_dir = 'file:///home/user/learning/AWS_Spark_Unstructured/input/input_csv'
    video_input_dir = 'file:///home/user/learning/AWS_Spark_Unstructured/input/input_video'
    pdf_input_dir = 'file:///home/user/learning/AWS_Spark_Unstructured/input/input_pdf'
    img_input_dir = 'file:///home/user/learning/AWS_Spark_Unstructured/input/input_img'
    ...
    job_bulletins_df = job_bulletins_df.withColumn('position', regexp_replace(['extract_position_udf']('value'), r'\r', ' '))
    job_bulletins_df = job_bulletins_df.withColumn('salary_end', udfs['extract_position_udf']('value').getField('salary_end'))
    job_bulletins_df = job_bulletins_df.withColumn('salary_end', udfs['extract_position_udf']('value').getField('salary_end'))
    ...
    job_bulletins_df = job_bulletins_df.withColumn('duties', udfs['extract_notes_udf']('value'))
    ...
    job_bulletins_df = job_bulletins_df.withColumn('application_location', udfs['extract_application_location']('value'))


    j_df = job_bulletins_df.select('file_name', 'start_date', 'end_date', 'salary_start', 'salary_end', 'classcode',
                                   'req', 'notes', 'duties', 'selection', 'experience_length', 'education_length', 'application_location')
